	...
	{:else if entries.length === 0}
		<Card>
			<div class="text-center py-12">
				...
				<a
					href="/journal"
					class="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors font-medium"
				>
					...
					>
						<div class="flex items-start justify-between gap-4">
							...
							<div class="flex items-center gap-2">
								...
								<svg
									class="w-5 h-5 text-gray-400 transition-transform duration-200 {selectedEntry?.id === entry.id ? 'rotate-180' : ''}"
									fill="none"
									stroke="currentColor"
									viewBox="0 0 24 24"
								>
