...
<Card>
	<div class="space-y-4">
		<div class="flex items-center justify-between">
			<h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Weekly Progress</h2>
			<span
				class="text-2xl font-bold {goalMet ? 'text-primary' : 'text-gray-600 dark:text-gray-400'}"
			>
				{completedDays} / 5
			</span>
		</div>
		...
		{#if goalMet}
			<div class="bg-primary/10 border-primary/20 rounded-lg border p-3 text-center">
				<p class="text-primary flex items-center justify-center gap-2 text-sm font-medium">
					<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
						<path
